...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  createSceneForgeProject: (projectDir: string, entryPath?: string, options?: { pipelineId?: string }) =>
    ipcRenderer.invoke('create-scene-forge-project', projectDir, entryPath, options),
  ...
  sceneForgeRemix: {
    ...
    runSegmentFrameVision: (input: {
      ...
      sourceAssetId: string;
      segmentId: string;
    }) => ipcRenderer.invoke('sceneForgeRemix:runSegmentFrameVision', input),
